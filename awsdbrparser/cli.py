...
@click.option('-C', '--custom', default=False, help='Define whether write data to a security es')
@click.option('-k', '--key', default="", help='Define the key access to a security es host')
@configure
